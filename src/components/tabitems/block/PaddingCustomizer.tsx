...
import {
  DownSquareOutlined, LeftSquareOutlined, RightSquareOutlined, UpSquareOutlined
  ...
  return (
    <>
      ...
      <Section>
        <Flex key={index}>
          {icon}
          <InputNumberWithUnit cssKey={`${cssKey}`} id={createId()} options={blockUnits} onChange={onChange}/>
        </Flex>
      </Section>
    )}
    </>
