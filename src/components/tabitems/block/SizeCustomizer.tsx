  ...
  return (
    <>
      <Section>
        <Flex>
          <ColumnWidthOutlined/>
          <InputNumberWithUnit cssKey={'width'} id={createId()} options={blockUnits} onChange={onChange}/>
        </Flex>
      </Section>
      <Flex>
        <ColumnHeightOutlined/>
        <InputNumberWithUnit cssKey={'height'} id={createId()} options={blockUnits} onChange={onChange}/>
      </Flex>
    </>
  );
};
