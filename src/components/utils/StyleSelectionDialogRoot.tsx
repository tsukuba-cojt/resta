...
import {
  StyleSelectionDialogContext,
  useStyleSelectionDialog,
} from '../../contexts/StyleSelectionDialogContext';
  ...
  return (
    <StyleSelectionDialogContext.Provider value={styleSelectionDialog}>
      ...
      >
        ...
        {urls.length == 0 && <p>{t('selection_dialog_no_contents')}</p>}
      </Modal>
